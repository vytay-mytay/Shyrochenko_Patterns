...
namespace ShyrochenkoPatterns.DAL.Migrations
{
    ...
    [Migration("20190321143157_AddChatEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShyrochenkoPatterns.Domain.Entities.Chat.Chat", b =>
                {
                    ...
                    b.HasIndex("LastItemId")
                        .IsUnique()
                        .HasFilter("[LastItemId] IS NOT NULL");
            ...
            modelBuilder.Entity("ShyrochenkoPatterns.Domain.Entities.Chat.LastItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ShyrochenkoPatterns.Domain.Entities.Chat.Chat", b =>
                {
                    b.HasOne("ShyrochenkoPatterns.Domain.Entities.Chat.LastItem", "LastItem")
                        .WithOne("Chat")
                        .HasForeignKey("ShyrochenkoPatterns.Domain.Entities.Chat.Chat", "LastItemId");
                });
            ...
            modelBuilder.Entity("ShyrochenkoPatterns.Domain.Entities.Chat.LastItem", b =>
                {
                    b.HasOne("ShyrochenkoPatterns.Domain.Entities.Chat.Message", "Message")
                        .WithMany()
