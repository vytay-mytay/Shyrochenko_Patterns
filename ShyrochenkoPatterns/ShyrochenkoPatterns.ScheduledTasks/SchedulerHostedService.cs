...
namespace ShyrochenkoPatterns.ScheduledTasks
{
    public class SchedulerHostedService : HostedService
    {
        ...
        protected override async Task ExecuteAsync(CancellationToken cancellationToken)
        {
            ...
            // first ofset which will shifted executing to rounded time
            var firstSpan = TimeSpan.FromSeconds(defaulSpan.TotalSeconds - date.Second);
            ...
            while (!cancellationToken.IsCancellationRequested)
            {
                ...
                await Task.Delay((firstLaunch)? firstSpan: defaulSpan, cancellationToken);
